<template>
  <div id="table">
    ...
    <div class="field">
      ...
      <div class="control">
        <input class="input" type="text" placeholder="Detalles del articulo" v-model="descripcion">
      </div>
    </div>
    ...
    <div class="field" v-if="categoria == 'ukulele'">
      ...
      <div class="control">
        <input class="input" type="text" placeholder="modelo del ukulele" v-model="modelo">
      </div>
    </div>
...
export default {
  ...
  methods:{
    ...
    async guardarArticulo(){
      try {
        await axios.post("http://192.168.0.8:3000/articulo",
            {
              nombre: this.nombre,
